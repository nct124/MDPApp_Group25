...
public class BlueToothDeviceListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView newDevicesListView = (ListView) findViewById(R.id.newDeviceList);
        newDevicesListView.setAdapter(mNewDevicesArrayAdapter);
        newDevicesListView.setOnItemClickListener(mDeviceClickListener);

        ListView pairedDevicesListView = (ListView) findViewById(R.id.pairedDeviceList);
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
            ...
            //String device_name = info.substring(0,info.length() - 18);
